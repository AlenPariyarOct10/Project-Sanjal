        ...
        <div class="modal-content max-h-full overflow-y-auto">
            ...
            <form id="{{module_id($module, "form")}}" onsubmit="handle{{$module}}Submit(event)" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    <label for="{{module_id($module, "name")}}" class="block font-medium required">Tag Name</label>
                    <input type="text" id="{{module_id($module, "name")}}" name="name" class="w-full px-3 py-2 border " placeholder="e.g. Sorting">
                </div>
...
@section("js")
    ...
    @include("admin.algorithm_tags.includes.script")
@endsection
