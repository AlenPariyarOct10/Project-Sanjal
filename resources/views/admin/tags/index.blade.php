...
@section("content")
    ...
    <div class="modal h-full" id="{{module_id($module, "modal")}}">
        <div class="modal-content max-h-full overflow-y-auto">
            ...
            <form id="{{module_id($module, "form")}}" onsubmit="handleTagSubmit(event)" enctype="multipart/form-data">
                <input type="hidden" id="{{module_id($module, "id")}}" name="id">
                <!-- Name -->
                <div class="form-group mb-3">
                    <label for="tagName" class="block font-medium required">Tag Name</label>
                ...
                <div class="form-group mb-3">
                    ...
                    <input id="tagKey" name="key" class="w-full px-3 py-2 border "
                              placeholder="This field is autogenerated" readonly>
                </div>
                ...
                <div class="form-group flex justify-end gap-3 mt-4">
                    <button type="button" class="btn btn-outline px-4 py-2" onclick="closeTagModal()">Cancel
                    </button>
