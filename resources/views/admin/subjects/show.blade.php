...
<main class="admin-container">
    <div class="max-w-6xl mx-auto px-4">
        ...
        <section class="border border-black p-8 hover-glow mb-6">
            ...
            <p class="text-sm text-gray-600 mb-4"><strong>Course:</strong> {{ $row->course->name ?? 'N/A' }}</p>
        ...
        <!-- ASSOCIATED PROJECTS -->
        <section>
            <h2 class="text-2xl font-bold mb-4">Projects for this Subject</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($row->projects as $project)
                    <div class="border border-black p-4 hover-glow">
                        <h3 class="font-bold">{{ $project->name ?? $project->title }}</h3>
                ...
                @empty
                    <p class="col-span-full text-gray-500 italic">No projects found for this subject.</p>
                @endforelse
            </div>
        </section>
    </div>
