        ...
        <div class="modal-content max-h-full overflow-y-auto">
            ...
            <form id="{{module_id($module, "form")}}" onsubmit="handle{{$module}}Submit(event)">
                ...
                <div class="form-group mb-3">
                    <label for="{{module_id($module, "name")}}" class="block font-medium required">Subject Name</label>
                    <input type="text" id="{{module_id($module, "name")}}" name="name" class="w-full px-3 py-2 border " placeholder="e.g. Project I">
                </div>

                <!-- Code -->
                <div class="form-group mb-3">
                    <label for="{{module_id($module, "code")}}" class="block font-medium">Subject Code</label>
                    <input type="text" id="{{module_id($module, "code")}}" name="code" class="w-full px-3 py-2 border " placeholder="e.g. CACS101">
                </div>

                <!-- Course -->
                <div class="form-group mb-3">
                    <label for="{{module_id($module, "course_id")}}" class="block font-medium required">Course</label>
                    <select id="{{module_id($module, "course_id")}}" name="course_id" class="w-full px-3 py-2 border">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea id="{{module_id($module, "description")}}" name="description" rows="3" class="w-full px-3 py-2 border "
                              placeholder="About this subject"></textarea>
                </div>
...
@section("js")
    ...
    @include("admin.subjects.includes.script")
@endsection
