    ...
    <main>
        <section class="admin-container">
            ...
            <div class="admin-section">
                ...
                <table id="universitiesTable" class="display nowrap w-full text-left">
                    <thead>
                    <tr>
                        <th>ID</th>
        ...
        <div class="modal-content max-h-full overflow-y-auto">
            ...
            <form id="universityForm" onsubmit="handleUniversitySubmit(event)" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea id="universityDescription" name="description" rows="3" class="w-full px-3 py-2 border " placeholder="About the university"></textarea>
                </div>

                <!-- Address -->
                <div class="form-group mb-3">
                    <label for="universityAddress" class="block font-medium">Address</label>
                    <input type="text" id="universityAddress" name="address" class="w-full px-3 py-2 border " placeholder="e.g., Kathmandu">
                </div>
                ...
                <div class="form-group mb-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="universityPhone" name="phone" class="w-full px-3 py-2 border " placeholder="e.g., +977-1-XXXXXXX">
                    </div>
                    <div>
                        <label for="universityEmail" class="block font-medium">Email</label>
                        <input type="email" id="universityEmail" name="email" class="w-full px-3 py-2 border " placeholder="e.g., info@uni.edu.np">
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="url" id="universityWebsite" name="website" class="w-full px-3 py-2 border " placeholder="https://www.university.edu.np">
                </div>
                ...
                <div class="form-group mb-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="url" id="universityFacebook" name="facebook" class="w-full px-3 py-2 border " placeholder="https://facebook.com/uni">
                    </div>
                    <div>
                        <label for="universityTwitter" class="block font-medium">Twitter</label>
                        <input type="url" id="universityTwitter" name="twitter" class="w-full px-3 py-2 border " placeholder="https://twitter.com/uni">
                    </div>
                    <div>
                        <label for="universityInstagram" class="block font-medium">Instagram</label>
                        <input type="url" id="universityInstagram" name="instagram" class="w-full px-3 py-2 border " placeholder="https://instagram.com/uni">
                    </div>
                    <div>
                        <label for="universityYoutube" class="block font-medium">YouTube</label>
                        <input type="url" id="universityYoutube" name="youtube" class="w-full px-3 py-2 border " placeholder="https://youtube.com/uni">
                    </div>
                    <div>
                        <label for="universityLinkedin" class="block font-medium">LinkedIn</label>
                        <input type="url" id="universityLinkedin" name="linkedin" class="w-full px-3 py-2 border " placeholder="https://linkedin.com/company/uni">
                    </div>
                </div>
