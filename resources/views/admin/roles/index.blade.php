        ...
        <div class="modal-content max-h-full overflow-y-auto">
            ...
            <form id="{{module_id($module, "form")}}" onsubmit="handle{{$module}}Submit(event)">
                ...
                <div class="form-group mb-3">
                    <label for="{{module_id($module, "title")}}" class="block font-medium required">Role Title</label>
                    <input type="text" id="{{module_id($module, "title")}}" name="title" class="w-full px-3 py-2 border " placeholder="e.g. Administrator">
                </div>
...
@section("js")
    ...
    @include("admin.roles.includes.script")
@endsection
