...
<head>
    ...
    <title>University Details - Nepal IT Project Hub</title>
    ...
    <div class="max-w-6xl mx-auto px-4">
        <nav class="flex justify-between items-center py-4">
            ...
            <ul class="hidden md:flex gap-6 list-none items-center" id="navLinks">
                ...
                <li><a href="colleges.html" class="text-gray-600 hover:text-black">Colleges</a></li>
...
<main class="py-12">
    <div class="max-w-6xl mx-auto px-4">
        <div id="universityDetailContainer"></div>

        <!-- Colleges Section -->
        <div class="mt-12">
            <h2 class="text-2xl font-bold mb-6">Colleges under this University</h2>
            <div id="universityColleges" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
        </div>

        <!-- Projects Section -->
        <div class="mt-12">
            <h2 class="text-2xl font-bold mb-6">Projects from this University</h2>
            <div id="universityProjects" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
        </div>

        <!-- Technologies Section -->
        <div class="mt-12">
            <h2 class="text-2xl font-bold mb-6">Popular Technologies</h2>
            <div id="universityTechnologies" class="flex flex-wrap gap-6"></div>
        </div>

        <!-- Algorithms Section -->
        <div class="mt-12">
            <h2 class="text-2xl font-bold mb-6">Popular Algorithms</h2>
            <div id="universityAlgorithms" class="flex flex-wrap gap-6"></div>
        </div>
    </div>
</main>
