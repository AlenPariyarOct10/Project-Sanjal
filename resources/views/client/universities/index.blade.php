...
<head>
    ...
    <title>Universities - Nepal IT Project Hub</title>
    ...
    <div class="max-w-6xl mx-auto px-4">
        <nav class="flex justify-between items-center py-4">
            ...
            <ul class="hidden md:flex gap-6 list-none items-center" id="navLinks">
                ...
                <li><a href="universities.html" class="font-bold text-black">Universities</a></li>
...
<section class="py-12 md:py-16 border-b border-gray-200">
    <div class="max-w-6xl mx-auto px-4 text-center">
        ...
        <p class="text-gray-600">Explore universities in Nepal and their colleges</p>
    </div>
</section>
...
<section class="py-12 md:py-16">
    <div class="max-w-6xl mx-auto px-4">
        <div class="mb-8">
            <input type="text" id="universitySearch" placeholder="Search universities..." class="w-full px-4 py-2 border border-gray-300 focus:outline-none focus:border-black">
        </div>

        <div id="universitiesList" class="grid grid-cols-1 md:grid-cols-2 gap-6"></div>
    </div>
</section>
