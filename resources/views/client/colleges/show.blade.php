...
<main class="py-12">
    <div class="max-w-6xl mx-auto px-4">
        <div id="collegeDetailContainer"></div>

        <!-- Projects Section -->
        <div class="mt-12">
            <h2 class="text-2xl font-bold mb-6">Projects from this College</h2>
            <div id="collegeProjects" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
        </div>

        <!-- Technologies Section -->
        <div class="mt-12">
            <h2 class="text-2xl font-bold mb-6">Popular Technologies</h2>
            <div id="collegeTechnologies" class="flex flex-wrap gap-6"></div>
        </div>

        <!-- Algorithms Section -->
        <div class="mt-12">
            <h2 class="text-2xl font-bold mb-6">Popular Algorithms</h2>
            <div id="collegeAlgorithms" class="flex flex-wrap gap-6"></div>
        </div>
    </div>
</main>
